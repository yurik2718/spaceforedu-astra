...
server {
    ...
    add_header Content-Security-Policy "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self' data:; connect-src 'self'; frame-src 'none'; frame-ancestors 'none'; object-src 'none'; manifest-src 'self'; worker-src 'self'; base-uri 'self'; form-action 'none'; upgrade-insecure-requests" always;
